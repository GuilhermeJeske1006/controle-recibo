            ...
            @foreach ($this->budgets as $item)
                <tr
                    ...
                    <td class="px-6 py-4 text-right">
                        ...
                        <a href="{{ route('budget.detail', ['budget' => $item->id]) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Ver</a>
