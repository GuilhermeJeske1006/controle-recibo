<form wire:submit="submit" class="mx-auto">
    ...
    <div class="relative z-0 w-full mb-5 group">
        ...
        <label for="name_company" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nome da
            empresa</label>
        <input wire:model="name_company" type="text" id="name_company"
    ...
    <div class="grid md:grid-cols-2 md:gap-6">
        ...
        <div class="relative z-0 w-full mb-5 group">
            ...
            <input wire:model="cnpj" type="cnpj" id="cnpj"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="(###.###.###-##)" />
            <div>
                @error('cnpj')
    ...
    <div class="relative z-0 w-full mb-5 group">
        ...
        <input wire:model="slogan" type="text" id="slogan"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
    ...
    <div class="grid md:grid-cols-2 md:gap-6">
        ...
        <div class="relative z-0 w-full mb-5 group">
            ...
            <div class="flex">
                ...
                <input type="text" wire:model='instagram' id="website-admin"
    ...
    <div class="relative z-0 w-full mb-5 group">
        ...
        <textarea wire:model='description' id="description" rows="4"
            ...
            placeholder="Escreva sobre a sua empresa..."></textarea>
    </div>

    <div class="grid md:grid-cols-2 md:gap-6">
        <div class="relative z-0 w-full mb-5 group">
            <label for="cep" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cep</label>
            <input wire:model.live.debounce.150ms="cep" type="text" id="cep"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
