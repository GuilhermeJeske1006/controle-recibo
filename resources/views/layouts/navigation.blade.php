    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('register.receipt')" :active="request()->routeIs('register.receipt')">
                        {{ __('Criar Recibo') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <button id="theme-toggle" type="button" class="text-gray-500 mr-3 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        @if (user()->is_master)
                        <x-dropdown-link :href="route('company.create')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                @if (user()->is_master)
                <x-responsive-nav-link :href="route('company.create')">
                    {{ __('Cadastrar empresa') }}
                </x-responsive-nav-link>
                @endif
