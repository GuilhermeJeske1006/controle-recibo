...
<nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
    <div class="flex justify-between flex-1 sm:hidden">
        ...
        <span
            class=" dark:bg-gray-800/50 dark:text-gray-400 dark:border-gray-800
        ...
        <div>
            <span class="relative z-0 inline-flex shadow-sm rounded-md">
                ...
                <span aria-disabled="true">
                    <span
                        class="relative inline-flex dark:bg-gray-800/50 dark:text-gray-400 dark:border-gray-800
                                items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300 cursor-default leading-5">{{
                        $element }}</span>
                </span>
                @endif
                ...
                <span aria-current="page">
                    <span class="
                                       ...
                                       dark:bg-gray-800/50 dark:text-gray-400 dark:border-gray-800
                ...
                @else
                <a href="{{ $url }}"
                    class="relative dark:bg-gray-800/50 dark:text-gray-400 dark:border-gray-800
                                    inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 hover:text-gray-500 focus:z-10 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150"
